  ...
  if (button3 == LOW) {
      ...
      if(entered==-1){
          ...
          if(entered==0){
             ...
             else if (temp<25 and temp>15) {
                selected = 1;
             }
             else if (temp<30 and temp>=25) {
                selected = 2;
             }
             else if (temp<=10 and temp>5) {
                selected = 3;
             }
          }
          else {
